...
const MyDeviceStatistic = ({route}) => {
  ...
  const [dateEnd, setEndDate] = useState(endDate(new Date()));
  ...
  return (
    <View style={styles.container}>
      <View>
          ...
          <View>
            ...
            <View style={{justifyContent: 'center', alignItems: 'center'}}>
              <Button
                ...
                mode="contained"
                onPress={() => {
                  console.log(deviceTokenG + 'navigationMyDeviceStatics');
                  let startTime = Math.ceil(date.getTime() / 1000);
                  let endTime = Math.ceil(dateEnd.getTime() / 1000);
                  navigation.navigate('MyDeviceStatisticDetail', {
                    startTime: startTime,
                    endTime: endTime,
        ...
        {/* <View>
          <Button1 onPress={showTimepicker} title="Show time picker!" />
        </View> */}
        {/* {show && (
          <DateTimePicker
            maximumDate={new Date()}
